...
if (Joystick3AMap > 30) { //3A is up
  if (Joystick3BMap > 30) { //3B is to right
    if (Joystick3AMap > Joystick3BMap) { //3A is bigger
      Left = Joystick3AMap;
    ...
    if (Joystick3AMap < Joystick3BMap) { //3B is bigger
      Left = Joystick3BMap;
  ...
  if (Joystick3BMap < -30) { //3B is to left
    if (Joystick3AMap > abs(Joystick3BMap)) { //3A is bigger
    ...
    if (Joystick3AMap < abs(Joystick3BMap)) { //3B is bigger
...
if (-30 > Joystick3AMap) { //3A down
  if (Joystick3BMap > 30) { //3B right
    if (abs(Joystick3AMap) > Joystick3BMap) { // 3A is bigger
    ...
    if (abs(Joystick3AMap) < Joystick3BMap) { //3B is bigger
  ...
  if (Joystick3BMap < -30) { //3B left
    if (abs(Joystick3AMap) > abs(Joystick3BMap)) { //3A is bigger
    ...
    if (abs(Joystick3AMap) < abs(Joystick3BMap)) { //3B is bigger
